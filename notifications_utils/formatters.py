...
def create_sanitised_html_for_url(link, *, classes="", style=""):
    ...
    return '<button style="background-color: #005ea2; -webkit-appearance: none; -moz-appearance: none; appearance: none; border: 0; border-radius: 0.25rem; cursor: pointer; display: inline-block; font-weight: 700; margin-right: 0.5rem; padding: 0.75rem 1.25rem; text-align: center; text-decoration: none; width: auto;"><a {}{}href="{}">{}</a></button>'.format(
        class_attribute,
        style_attribute,
